...
inputEmail.addEventListener("focus", function () {
  ...
  inputEmail.parentElement.querySelector("label").classList.remove("errorLabel");
});
...
if (document.querySelector(".alertPassword")) {
    ...
    this.parentElement.parentElement.removeChild(
      this.parentElement.parentElement.querySelector(".alertPassword")
    );
  }
  inputPassword.classList.remove("error");
  inputPassword.parentElement.querySelector("label").classList.remove("errorLabel");
});